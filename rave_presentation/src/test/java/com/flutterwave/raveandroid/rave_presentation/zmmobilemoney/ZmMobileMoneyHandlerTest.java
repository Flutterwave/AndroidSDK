...
public class ZmMobileMoneyHandlerTest {
    @Mock
    ZmMobileMoneyContract.Interactor interactor;
    @Inject
    ...
    private ZmMobileMoneyHandler paymentHandler;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        paymentHandler = new ZmMobileMoneyHandler(interactor);
    ...
    public void chargeZmMobileMoney_onSuccess_requeryTxCalled() {
        ...
        paymentHandler.chargeZmMobileMoney(payload, generateRandomString());
    ...
    public void chargeZmMobileMoney_onSuccessWithNullData_onPaymentError_noResponse_Called() {
        ...
        onGhanaChargeRequestCompleteArgumentCaptor.getAllValues().get(0).onSuccess(generateNullZMChargeResponse());
