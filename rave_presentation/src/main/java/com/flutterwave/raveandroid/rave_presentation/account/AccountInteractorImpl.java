...
class AccountInteractorImpl implements AccountContract.AccountInteractor {
    ...
    AccountInteractorImpl(AccountPaymentCallback callback) {
        this.callback = (callback != null) ? callback : new NullAccountPaymentCallback();
    ...
    public void onBanksListRetrieved(List<Bank> banks) {
        callback.onBanksListRetrieved(banks);
    }

    @Override
    public void onGetBanksRequestFailed(String message) {
        callback.onGetBanksRequestFailed(message);
    }
    ...
    public void collectOtp(String publicKey, String flutterwaveReference, String validateInstruction) {
        ...
        callback.collectOtp(validateInstruction);
    }
