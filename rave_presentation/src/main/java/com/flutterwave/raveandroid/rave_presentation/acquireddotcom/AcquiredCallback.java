...
public interface AcquiredCallback {
    /**
     ...
     * <p>
     * If it does, it means the transaction has been completed and you can now call {@link SaBankAccountPaymentManager#checkStatus()} ()} to check the transaction status.
     *
