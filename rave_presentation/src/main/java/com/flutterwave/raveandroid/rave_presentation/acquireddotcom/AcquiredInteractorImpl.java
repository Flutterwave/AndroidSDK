...
class AcquiredInteractorImpl implements AcquiredContract.Interactor {

    private AcquiredCallback callback;
    private String flwRef;
    private FeeCheckListener feeCheckListener;


    AcquiredInteractorImpl(AcquiredCallback callback) {
        this.callback = (callback != null) ? callback : new NullAcquiredCallback();
