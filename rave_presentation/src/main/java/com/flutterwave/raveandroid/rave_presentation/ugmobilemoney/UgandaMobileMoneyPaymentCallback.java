...
public interface UgandaMobileMoneyPaymentCallback {
     ...
     * <p>
     * If it does, it means the transaction has been completed and you can now call {@link UgandaMobileMoneyPaymentManager#onWebpageAuthenticationComplete()} to check the transaction status.
     *
