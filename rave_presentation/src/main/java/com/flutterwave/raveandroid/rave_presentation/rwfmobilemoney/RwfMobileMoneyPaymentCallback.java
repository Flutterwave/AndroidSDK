...
public interface RwfMobileMoneyPaymentCallback {
     ...
     * <p>
     * If it does, it means the transaction has been completed and you can now call {@link RwfMobileMoneyPaymentManager#onWebpageAuthenticationComplete()} to check the transaction status.
     *
