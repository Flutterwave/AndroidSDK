...
import com.flutterwave.raveandroid.uk.UkBankAccountFragment;
...
public class RavePayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ravePayInitializer.isWithUkBankAccount()) {
            raveFragments.add(new RaveFragment(new UkBankAccountFragment(), "UK BANK ACCOUNT"));
        }
