...
public class NetworkRequestImpl implements DataRequest.NetworkRequest {
    ...
    private void createService(boolean isLive) {
        ...
        if (eventLoggingRetrofit == null) {
            eventLoggingRetrofit = new Retrofit.Builder()
        ...
        service = mainRetrofit.create(ApiService.class);
        eventLoggerService = eventLoggingRetrofit.create(EventLoggerService.class);
    }
