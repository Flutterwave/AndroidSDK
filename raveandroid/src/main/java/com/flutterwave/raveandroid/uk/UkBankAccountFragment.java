 ...
 */
public class UkBankAccountFragment extends Fragment implements UkBankAccountContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        presenter = new UkBankAccountPresenter(getActivity(), this);
...
//                    .setCountry(ravePayInitializer.getCountry())
            ...
            Payload body = builder.createUkBankAccountPayload();
...
//        dismissDialog();
    ...
    public void showTransactionPage(final ChargeResponse response) {
        if (getContext() != null) {
                ...
                ((TextView) dialog.findViewById(R.id.amount)).setText(String.format("%s %s", "£", response.getData().getData().getAmount()));
