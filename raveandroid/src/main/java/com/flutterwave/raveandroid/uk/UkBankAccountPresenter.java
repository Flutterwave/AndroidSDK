...
public class UkBankAccountPresenter implements UkBankAccountContract.UserActionsListener {
    private Context context;
    private UkBankAccountContract.View mView;

    public UkBankAccountPresenter(Context context, UkBankAccountContract.View mView) {
    ...
    public void chargeUkBankAccount(final Payload payload, final String encryptionKey) {
        ...
        new NetworkRequestImpl().chargeUkBankAccount(body, new Callbacks.OnChargeRequestComplete() {
            @Override
