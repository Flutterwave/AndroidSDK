...
public class RavePayManager {
    ...
    boolean withUkBankAccount = false;
    boolean isWithUkBankAccount = false;
    ...
    public RavePayManager acceptUkBankAccount(boolean withUkBankAccount) {
        this.withUkBankAccount = withUkBankAccount;
        return this;
    }
    ...
    public RavePayInitializer createRavePayInitializer() {
        return new RavePayInitializer(email, amount, publicKey, encryptionKey, txRef, narration,
                ...
                withGHMobileMoney, withUgMobileMoney, withUkBankAccount, withAch, theme, staging, meta, subAccounts,
                payment_plan,
                isPreAuth);
       }
}